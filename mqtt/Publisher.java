...
class Publisher 
{
    public static void main(String []args) throws Exception 
    {
        ...
        String host = env("APOLLO_HOST", "106.38.208.123");
        int port = Integer.parseInt(env("APOLLO_PORT", "1883"));
        final String destination = arg(args, 0, "/topic/test");

        int messages = 10000;
      
        String DATA = "++++++++++abcdefghijklmnopqrstuvwxyz this is publisherA";
