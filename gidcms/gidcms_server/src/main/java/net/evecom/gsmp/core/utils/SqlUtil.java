...
public class SqlUtil {
     ...
     * @author Nick Lv
     * @created 2017 /03/01 10:45:52 Get param array object [ ]. 
    ...
    private static Map<String, Object> getClause(Map<String, Object> queryMap, String oper) {
        ...
        //        boolean flag = false;
        //        // 对resultMap中的数据进行处理。
        //        Set<Map.Entry<String, Object>> querySet = queryMap.entrySet();
        //        int markNum = 0;
        ...
        //                // System.out.println("operAndColumn"+operAndColumn[0]);
        //
        ...
        //                    markNum--;
        //                } else {
        //                    sb.append(BLANK).append(operAndColumn[0]).
        //              append(BLANK).append(MARK + markNum).append(BLANK);
        //
        ...
        //            }
        //
        //            //if (operAndColumn[0].equals("like")) {
        ...
        //
        //        if (valueList.size() == 0) {
        //            if (CommUtil.isNotEmpty(sb.toString())) {
